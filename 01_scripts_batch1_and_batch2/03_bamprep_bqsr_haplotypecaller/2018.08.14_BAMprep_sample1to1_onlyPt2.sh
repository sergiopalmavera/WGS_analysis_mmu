...
# Define path to tmp
TMP=/home/fb4/palma-vera/tmp
#TMP=/projekte/I2-SOS-FERT/04_alignments_merged_dedup/tmp #not enough space here
...
do
	...
	# Make a temporary directory for this sample
	#mkdir $TMP/$SAMP
	...
	then
		...
		rm $TMP/$SAMP/$SAMP.merged.sorted.dedup.bam #in case I need to rerun analysis
	else
