...
# tabulate high-snp-genes intersecting with high-genes
RED_genes_HIGH %>% 
...
### Fst Heatmap (any Fst > 0.2)
```{r fst_heatmap_low_scores_removed, fig.width=10, fig.height=13}

ma <- ma[apply(ma,1,function(x) any(x > 0.2)),]

pheatmap(ma,na_col = "darkgrey",cluster_cols = F, cluster_rows = T, display_numbers = T, angle_col = 45,main = "Fst scores (>0.2 any) per (HIGH-impact)SNP in RED-genes")
