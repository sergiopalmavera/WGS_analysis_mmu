...
then
	...
	echo "Run the script clear_dir.sh with the first 3 arguments as now to clear directories and files to resubmit this job"
	echo "!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!"
	printf "\n"
else
	...
	do
		...
		nohup ./ConsolidateGVCFs_template.sh $dir_intervals/${nm}.bed $dir_db/$nm $batch_size &> $dir_logs/ConsolidateGVCFs_chr${nm}.out & # submit job
