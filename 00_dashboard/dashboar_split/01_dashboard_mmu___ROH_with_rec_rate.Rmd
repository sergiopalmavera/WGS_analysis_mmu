...
roh_dat <- vroom(here("batches123_09_ROH/output/ROH_with_rec_rate_regions.table")) %>% 
...
dim(roh_dat) #207159     11
```

### Intro

* Runs of homozygosity (ROHs) were calculated with bcftools 1.9 (roh) with a constant recombination rate of 0.51e-8
...
#png(here("00_dashboard/for_manuscript/barplot_roh_with_rec_genomic_fractions.png"), res = 300, units = "px", height = 2000, width = 2000)
