...
out_vcf=../output/cohort_biallelicSNPs_VQSR95_PASS_AddedMissingness.recode.filtered.vcf
...
$GATK/gatk SelectVariants \
	...
	-L ../output/keep_snps_DU6_12_REST_15.intervals \
	-O ${out_vcf/.vcf/.TMP.vcf}

# some sites could loose the ALT allele after adding missingness. Keep sites having at least on ALT allele count
