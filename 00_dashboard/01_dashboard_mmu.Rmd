...
rdd_q25_q85 <- readRDS(here("00_dashboard/data/rdd_q25_q85.rds"))
...
dim(rdd_q25_q85_genes) #1395    9
head(rdd_q25_q85_genes)
rdd_q25_q85_genes %>% group_by(pop) %>% summarise(n())
...
rdd_q25_q85_genes_gobp <- rdd_q25_q85_genes %>% 
  ...
  dplyr::select(pop, mcols.gene_symbol, go_id)

rdd_q25_q85_genes_gobp %>% group_by(pop) %>% summarise(n())
...
rdd_q25_q85_genes_kegg <- rdd_q25_q85_genes %>% 
  ...
  dplyr::select(pop, mcols.gene_symbol, pathway_id)
