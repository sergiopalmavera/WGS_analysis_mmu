...
### Distinct-heatmap
```{r Export_table_of_RED_genes_qith_mean_fst_for_manual_exploration, eval = FALSE}
...
```{r find_and_vis_distinctly_differentiated_RED_genes, , fig.width=10, fig.height=8}
...
RED_gene_mean_fst_distinct %>% datatable(options = list(pageLength = 200), caption = "Mean Fst RED Genes", rownames = FALSE)
...
tab2 %>%
  datatable(options = list(pageLength = 100), 
            caption = "Mean Fst Candidate Genes (genes with a high-impact SNP)\nNote that n_snps refers to the number of SNPs in the cohort VCF. It is possible that less number of SNPs were used for mean calculation. Information to be added later.")
