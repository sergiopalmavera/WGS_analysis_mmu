...
pop_vcf=../output/cohort_biallelicSNPs_VQSR95_PASS_withmissingness.filtered.${pop}.vcf
...
java -jar $PICARD/picard.jar CollectVariantCallingMetrics \
	INPUT=$pop_vcf \
	OUTPUT=../output/cohort_biallelicSNPs_VQSR95_PASS_withmissingness.filtered.${pop} \
