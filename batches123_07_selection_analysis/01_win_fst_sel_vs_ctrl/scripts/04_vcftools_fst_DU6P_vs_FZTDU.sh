...
time $vcftools/vcftools --vcf $vcf_dir/$vcf_nm --weir-fst-pop $lines_dir/vcf_samples_$pop1 --weir-fst-pop $lines_dir/vcf_samples_$pop2 --fst-window-size 50000 --fst-window-step 25000 --out $out 
