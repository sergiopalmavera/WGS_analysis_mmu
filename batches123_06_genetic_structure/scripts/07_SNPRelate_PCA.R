...
# convert VCF to GDS
vcf <- "../data/cohort_biallelicINDELs_VQSR99_PASS_withmissingness.filtered.ldpruned.vcf"

seqVCF2GDS(vcf, "../data/cohort_biallelicINDELs_VQSR99_PASS_withmissingness.filtered.ldpruned.gds")
...
data.frame(PC=1:7, varprop = pca$varprop[1:7]*100) %>% write.csv("../data/pc_pct_INDELs.csv")
...
write.csv(tab, "../data/pc_eigenscores_INDELs.csv")
